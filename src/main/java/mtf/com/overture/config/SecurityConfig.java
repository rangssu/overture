...
import mtf.com.overture.user.service.CustomOAuth2UserService;
import mtf.com.overture.user.oauth.OAuth2FailureHandler;
import mtf.com.overture.user.oauth.OAuth2SuccessHandler;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/events", "/api/v1/events/*", "/api/v1/events/*/grades", "/api/v1/events/*/seats").permitAll()
